const CELULAR_EMPRESA = '5511944668232';
...
cardapio.metodos = {
        ...
        if (MEU_CARRINHO.length > 0) {
            ...
            $.each(MEU_CARRINHO, (i, e) => {
                ...
                if (e.id.includes("milk")) {
                    ...
                    console.log(MEU_CARRINHO[i].isacrecimo);

                    // If para saber se o item do carrinho contem acrescimo 
                    if ((MEU_CARRINHO[i].isacrecimo) === 'true') {

                        console.log("IF Acréscimo isTrue");
                        ...
                        if ((MEU_CARRINHO[i].isbebida) === 'false') {

                        $.each(ACRESCIMOS['acrescimos-simples-comum'], (idAcrescimoComum, acrescimoComum) => {
                            let acrecimosComuns = cardapio.templates.acrescimoComum
                                .replace(/\${id}/g, acrescimoComum.id)
                                .replace(/\${nome}/g, acrescimoComum.name)
                                .replace(/\${idCarrinho}/g, e.idCarrinho);
                        ...
                        // lista os acrescimos especiais disponíveis para o item
                        $.each(ACRESCIMOS['acrescimos-simples-especial'], (idAcrescimoEspecial, acrescimoEspecial) => {
                            let acrecimosEspeciais = cardapio.templates.acrecimosEspecial
                                .replace(/\${id}/g, acrescimoEspecial.id)
                                .replace(/\${nome}/g, acrescimoEspecial.name)
                                .replace(/\${idCarrinho}/g, e.idCarrinho)
    ...
    buscarCep: () => {
        ...
        if (cep != '') {
            ...
            if (validaCep.test(cep)) {
                ...
                $.getJSON("https://viacep.com.br/ws/" + cep + "/01001000/json/", function (dados) {
                    ...
                    if (!("erro" in dados)) {
                        ...
                        if (dados.uf == 'MG') {
                            ...
                            cardapio.metodos.mensagem('Desculpe, no momento só atendemos em São Paulo.')
                        }
    ...
    finalizarPedido: () => {
        ...
        if (MEU_CARRINHO.length > 0 && MEU_ENDERECO != null) {
            ...
            var texto = `Olá, já realizei o meu pedido!\n\n`;
...
cardapio.templates = {
    ...
    <div class="col-12 col-lg-3 col-md-3 col-sm-6 mb-3 wow fadeInUp">
        <div class="card card-item" id="\${id}">
            ...
            <p id="title-produto" class="title-produto text-center mt-4">
                <b>\${nome}</b>
            </p>
    ...
    <div class="itemCarrinho" id="item-carrinho_\${id}_\${idCarrinho}">
        <div class="col-12 item-carrinho">
            ...
            <div class="dados-produtos">
                <p id="title-produto" class="title-produto"><b>\${nome}</b></p>
        ...
        <div class="col-12 acrescimos animated bounceInDown" id="acrescimos-\${idCarrinho}">
                <p id="title-produto" class="title-produto"><b>Acrescimos Comuns</b></p>
                ...
                <p id="title-produto-especial" class="title-produto especial"><b>Acrescimos Especiais</b></p>
    ...
    <div class="itemCarrinho" id="item-carrinho_\${id}_\${idCarrinho}">
        ...
        <div class="col-12 acrescimos animated bounceInDown" id="sorvetes-\${idCarrinho}">
                <p id="title-produto" class="title-produto"><b>Escolha os Sorvetes</b></p>
